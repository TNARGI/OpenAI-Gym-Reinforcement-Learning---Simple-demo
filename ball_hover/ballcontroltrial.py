...
env = gym.make("BallControlEnv-v0")
...
def ready():
    #print("type 'ready' to see results")
    userInput = input("type 'ready' to see results. \n")
...
if(mode == "random"):
    ...
    for episode in range(1, totalEpisodes+1):
        ...
        while not done:
            ...
            action = random.choice([0,1,2,3]) # take a random action
